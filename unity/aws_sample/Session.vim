...
set tabstop=4
set title
set window=5333101985690288128
set nowrapscan
...
badd +15 Assets/Scripts/ScrollViewController.cs
badd +42 Assets/Scripts/HttpManager.cs
badd +5 Assets/Scripts/PublicContents.cs
argglobal
%argdel
